...
export function MCResponsables() {
  return (
    <>
      <HeadSection label="MEDIDAS CORRECTIVAS" break_section bb />
      <Row height_head_cell={30}>
        ...
        <Cell
          width={20}
          label={`Completar en la fecha de ejecucion propuesta, el ESTADO de la implementacion de la medida correctiva \n (realizada, pendiente, en ejecucion)`}
          hide_content
          bb_head={false}
