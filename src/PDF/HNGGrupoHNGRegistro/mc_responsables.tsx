    ...
    <>
      ...
      <Row height_head_cell={30}>
        ...
        <Cell
          ...
          bb_head={false}
        />
        <Cell width={7.5} label={`ESTADO`} hide_content bb_head={false} />
        <Cell
          width={10}
          label={`FECHA DE \n CONTROL`}
          hide_content
          bb_head={false}
        />
        <Cell width={17.5} label={`COMENTARIOS`} hide_content bb_head={false} />
      </Row>
      ...
      <Row>
        ...
        <Cell width={7.5} value={`Realizada-Pendiente-`} hide_head />
        <Cell width={10} value={`Realizada-Pendiente-`} hide_head />
        <Cell width={17.5} value={`Realizada-Pendiente-`} hide_head />
      </Row>
