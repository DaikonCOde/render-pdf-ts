...
export function MCResponsables() {
  return (
    <>
      <HeadSection label="33. MEDIDAS CORRECTIVAS" bt={false} bb />
      <Row height_head_cell={30}>
        <Cell
          width={50}
          label={`¿QUÉ MEDIDAS CORRECTIVAS SE IMPLEMENTARÁN PARA ELIMINAR LA CAUSA QUE ORIGINÓ EL \n INCIDENTE PELIGROSO O INCIDENTE Y EVITAR LA RECURRENCIA?`}
          hide_content
          bb_head={false}
        ...
        <Cell
          width={25}
          label={`INDICAR RESPONSABLES DE LA \n IMPLEMENTACIÓN`}
          hide_content
          bb_head={false}
        />
        <Cell
